...
public class JDBCTest {
    ...
    public void testJdbcConnect() throws IOException, SQLException, ClassNotFoundException {
        ...
        this.driver = (String)prop.get("jdbc.driver");
        this.url = (String)prop.get("jdbc.url");
        this.username = (String)prop.get("jdbc.username");
        this.password = (String)prop.get("jdbc.password");
