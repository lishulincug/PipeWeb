				...
				initView:function(){
					...
					if(data){
						for(var index in data){
							var videoUIIndexGroup=$('<div class="video-ui-index-group"><ul><label>'+data[index].name+'</label></ul></div>');
							videoUIIndexGroup.height(groupHeight);
							fn.vedeoUIIndex.append(videoUIIndexGroup);
							var ul=videoUIIndexGroup.find("ul");
					...
					var container=$("div.video-ui-body");
					...
					$this.find("div.video-ui-body div ul li").each(function(){
						var object=$(p.videoBody());
						$(this).append(object);
//						if(p.videoInit.apply(object.get(0),[object.get(0).data])){}
					});
				},
				...
				initEvent:function(){
					...
					$this.on("dblclick","div.video-ui-index-group ul li",function(){
						...
						if(p.videoStart.apply(object.get(0),[$(this).get(0).data])){
							$this.find("div.video-ui-index-group ul li").removeClass("selected");
							$(this).addClass("selected");
							object.get(0).data=$(this).get(0).data;
						}						
					});
					...
					$this.on("click","li.video-ui-tool-zoomIn",function(){
						...
						var object=$(fn.body).find("object");
						if(!object.get(0).data){
							return false;
						}
						if(p.videoZoomIn.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-zoomOut",function(){
						...
						if(p.videoZoomOut.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-top",function(){
						...
						if(p.videoTop.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-bottom",function(){
						...
						if(p.videoBottom.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-left",function(){
						...
						if(p.videoLeft.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-right",function(){
						...
						if(p.videoRight.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-reset",function(){
						...
						if(p.videoReset.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-start",function(){
						...
						if(p.videoStart.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-pause",function(){
						...
						if(p.videoPause.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-zoomOutFocal",function(){
						...
						if(p.videoZoomOutFocal.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-zoomInFocal",function(){
						...
						if(p.videoZoomInFocal.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-openWiper",function(){
						...
						if(p.videoOpenWiper.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-closeWiper",function(){
						...
						if(p.videoCloseWiper.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-zoomOutAperture",function(){
						...
						if(p.videoZoomOutAperture.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-zoomInAperture",function(){
						...
						if(p.videoZoomInAperture.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-printScreen",function(){
						...
						if(p.videoPrintScreen.apply(object.get(0),[object.get(0).data])){
					...
					$this.on("click","li.video-ui-tool-allScreen",function(){
						...
						if(p.videoAllScreen.apply(object.get(0),[object.get(0).data])){
